  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <div className="bg-white rounded-lg border overflow-hidden">
        ...
        <Header description="You can see and manage all your patients here">Patients list</Header>
                  ...
                  <TableRow key={patient.id}>
                    ...
                    <TableCell>
                      <div className="flex gap-2">
                        <Link href={`/admin/patient-management/patient-list/view-patient-list?id=${patient.uhid}`}>
