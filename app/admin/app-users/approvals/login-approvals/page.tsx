...
import type { LoginApproval } from "@/types/app-users/app-user.type"
...
export default function LoginApprovalsPage() {
  ...
  const [selectedApproval, setSelectedApproval] = useState<LoginApproval | null>(null)
  const [rejectReason, setRejectReason] = useState("")

  // Mock data for login approvals (users trying to login)
  const [loginApprovals] = useState<LoginApproval[]>([
    {
      id: "1",
      name: "James",
    ...
    },
    {
      ...
      phoneNumber: "+91 77889-12345",
      status: "Pending",
      type: "login",
      nmcID: "NMC/REG/2023/456789",
      iadvlNo: "IADVL/MH/2025/90123",
    },
  ])

  // Filter approvals based on search term and status filter
  const filteredApprovals = loginApprovals.filter((approval) => {
    // Search filter
    const matchesSearch =
  ...
  return (
    <>
      ...
      {/* Header */}
      <Header description="Pending users who are trying to login">Login Approvals</Header>
                    ...
                    <TableCell>
                      {approval.status === "Pending" ? (
                        <div className="flex gap-4">
                          ...
                          >
                            <CheckCircle className="h-3 w-3 m-0" />
                            Approve
                          </Button>
                          <Button
                            variant="ghost"
